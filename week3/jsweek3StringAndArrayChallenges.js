...
// 2.4 Write a console.log statement 
// that explains in words you think the new value of the array is.
console.log("the new element 'meerkat' will be at index 1, and favoriteAnimals will be Array(5) [\"blowfish\", \"meerkat\", \"capricorn\", \"giraffe\", \"turtle\"]");

// 2.5 Log your new array!
console.log(favoriteAnimals);

// 2.6 Log the length of the array, 
// add a message: 'The array has a length of: ' (here you should show the length of the array).
...
// but you don't know the position or the index of the item in the array, 
// how can you find it?

// 2.10 Log the index of 'meerkat'. 
// Add a message so it says: 'The item you are looking for is at index: ' 
